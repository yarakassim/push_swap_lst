...
/*   Updated: 2022/02/17 12:40:16 by ykassim-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void sort_three(t_lst **stack_a)
{
	...
	if (less_than(first, second) && high_than(second, third) && less_than(first, third))
	{
		reverse_rotate(stack_a, 0);
		swap(stack_a, 0);
	}
	else if (less_than(first, second) && high_than(second, third) && high_than(first, third))
			reverse_rotate(stack_a, 0);
	else if (high_than(first, second) && less_than(second, third) && high_than(first, third))
			rotate(stack_a, 0);
